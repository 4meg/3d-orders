// ═══════════════════════════════════════════════════════════
//  /api/waseet-create-order
//  ينشئ طلب توصيل بشركة الوسيط ويرجع qr_id و qr_link
//
//  الاستخدام: POST /api/waseet-create-order
//  Body (JSON): {
//    client_name, client_mobile, city_id, region_id,
//    location, type_name, items_number, price, package_size,
//    merchant_notes (اختياري), replacement (0/1)
//  }
// ═══════════════════════════════════════════════════════════
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // ── تنسيق رقم الهاتف لصيغة الوسيط: +964XXXXXXXXXX ──
    ...
    // الوسيط يرجع data كمصفوفة فيها عنصر واحد
